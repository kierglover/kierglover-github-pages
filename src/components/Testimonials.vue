...
export default {
     ...
     components: {
          'carousel': Carousel,
          'slide': Slide,
          'test-content': TestimonialContent,
     },
}
</script>
